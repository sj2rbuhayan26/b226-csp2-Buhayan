...
public class SongDao  {
    ...
    // [Section] -> DML
    // Create Song
    public void createSong(int id,int album_id,String title, String length, String genre ) {
        String query = "INSERT INTO songs (id, album_id, title, length, genre) " + // create statement
    ...
    // Update Song
    public void updateSong(int id, int album_id,String title, String length, String genre) {
        String query = "UPDATE songs SET id = ?, title = ?, length = ?, genre = ? WHERE album_id = ?"; // parametherized query
